...
Built with Python, driven by the Groq API, and grounded in deeply researched DBZ lore, this project is a dynamic, narrative-driven experience featuring rogue-like progression and turn-based combat.
...
* **Joshua Chaney (MVSU)** - PM & Junior Dev: DBZ Wiki lore scraping, game architecture, and strict LLM prompt engineering.
